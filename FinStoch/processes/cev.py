...
class ConstantElasricityOfVariance:
    ...
    A class to model the Constant Elasricity of Variance (CEV) process.
    ...
    gamma :
        Getter and setter for the elasticity.
    T :
    ...
    def simulate(self) -> np.ndarray:
        """
        Simulates paths of the CEV model.
    ...
    def plot(
        ...
        **kwargs,
        ...
        title : str, optional
            Title for the plot. Default is 'Constant Elasticity of Variance'.
        ylabel : str, optional
