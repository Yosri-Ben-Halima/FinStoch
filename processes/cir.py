...
class CoxIngersollRoss:
    ...
    """
    def __init__(self, S0: float, mu: float, sigma: float, theta: float, num_paths, start_date: str, end_date: str, granularity: str) -> None:
        """
    ...
    def plot(self, paths=None, title="Cox-Ingersoll-Ross", ylabel='Value', fig_size: tuple=None, **kwargs):
        """
